package site.addzero.aio.memory.transport

import kotlinx.serialization.SerializationException
import kotlinx.serialization.encodeToString
import kotlinx.serialization.json.Json
import site.addzero.aio.memory.bindings.PluginRootFunctions
import site.addzero.aio.memory.bindings.*
import site.addzero.aio.memory.model.*
import site.addzero.aio.memory.storage.MemoryStore
import site.addzero.aio.memory.retrieval.exportContext

internal object PluginRootFunctionsExportsImpl : PluginRootFunctions.Exports {
    override fun describe() = Metadata.Description("Memory", listOf(Metadata.PageDefinition(
        "memory", "记忆图谱", "index.html", Metadata.Scene("community", "社区插件"), emptyList(), null, Metadata.Surface.WORKSPACE,
    )))
